...
#print(message[0:5])# we can specify where to start and end and first number is incluside and the other is exclusive if first is nothing then it will be considerd as min and if last is empty the considers as max
